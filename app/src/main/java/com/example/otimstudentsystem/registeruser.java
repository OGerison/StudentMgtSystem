...
//          End of shared Preference
        ...
        adapterRegItems = new ArrayAdapter<String>(this, R.layout.list_item, registerItems);
            ...
            public void onClick(View v) {
                ...
                if(RegAs == "Student"){
                    if (regno.getText().toString().trim().length() <= 0
                        ...
                        //dont forget validate password and confirm password
                        Toast.makeText(registeruser.this, "All Fields for Student are Required!!!",
                        ...
                        Toast.makeText(registeruser.this, "Student Added Successfully", Toast.LENGTH_LONG).show();
                    ...
                    if (name.getText().toString().length() <= 0
                        ...
                        //dont forget validate password and confirm password
                        Toast.makeText(registeruser.this, "All Fields for Lecturer are Required!!!",
                                Toast.LENGTH_LONG).show();
                    } else {
//--------------------inserting the data to the database--------------------------
                    ...
                    Toast.makeText(registeruser.this, "Selected staff or none at all!!!",
                            Toast.LENGTH_LONG).show();
                }
        ...
        DelBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (RRNo.trim().length() <= 0){
                    Toast.makeText(registeruser.this, "Regno field is Required to Delete!!",
                            Toast.LENGTH_LONG).show();
                }
                else{
                    //getting access to the database by instantiating the subclass of SQLiteOpenHelper
                    ...
                    String[] selectionArgs = { RRName };
                    // Issue SQL statement.
                    try {
                        int deletedRows = db.delete(registeruser.UserDetailsContract.UserEntry.TABLE_NAME, selection, selectionArgs);
                        if (deletedRows > 0 ){
                            Toast.makeText(registeruser.this, RRNo+" Deleted Successfully",
                                    Toast.LENGTH_LONG).show();
                        }
                        else{
                            Toast.makeText(registeruser.this, RRNo+" User Not Deleted May Not Be Found",
                                    Toast.LENGTH_LONG).show();
                        }
                    }
                    catch (Exception e){
