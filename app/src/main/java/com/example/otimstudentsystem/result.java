...
//        Showing the Logged in User from LoginMain Activity
        ...
        Toast.makeText(result.this, "Saved User Info:" + TheFetchedLoggedUser, Toast.LENGTH_SHORT).show();
        Toast.makeText(result.this, "And the UserName is:" + LoggedUserName, Toast.LENGTH_SHORT).show();
...
//        End database query
            ...
            Toast.makeText(result.this, "This might be Admin :", Toast.LENGTH_SHORT).show();

        }

        resultReg = findViewById(R.id.ResultRegNumber);
...
//                Checking if its HOD inserting or Lecturer inserting
                if(TheFetchedLoggedUser.equals("Lecturer")){
                    ...
                    if (resultReg.getText().toString().trim().length() <= 0
                        ...
                        Toast.makeText(result.this, "All Fields for StudentResults are Required!!!",
                        ...
                        Toast.makeText(result.this, "Student Results Added Successfully", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(result.this, "You Are not Authorized to alter Student data", Toast.LENGTH_LONG).show();
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(TheFetchedLoggedUser.equals("HOD")){
                    ...
                    ResultFinalMark = resultFinal.getText().toString();
                    if (resultReg.getText().toString().trim().length() <= 0) {
                        Toast.makeText(result.this, "RegNo is required for studentResult Edit Record!!",
                                Toast.LENGTH_LONG).show();
                    }
                    else{
...
// Which row to update, based on the title
                        ...
                        if (ResultRno.trim().length() <= 0
                            ...
                            Toast.makeText(result.this, "All Fields Are Required For Editing!!!",
                                    Toast.LENGTH_LONG).show();
                        }
                        else {
                            try {
                                ...
                                int count = db.update(
                                        ...
                                        selectionArgs);
                                if (count > 0 ){
                                    Toast.makeText(result.this, ResultRno+" Edited Successfully",
                                            Toast.LENGTH_LONG).show();
                                }
                                else{
                                    Toast.makeText(result.this, ResultRno+" StudentResults Not Edited, May Not Be Found",
                                            Toast.LENGTH_LONG).show();
                                }

                            }
                            catch (Exception e){
                                Toast.makeText(result.this, e.getMessage().toString()+"---Error Editing Student Results",
                                        Toast.LENGTH_LONG).show();
                            }
...
// Which row to update, based on the title
                    ...
                    Toast.makeText(result.this, "Editing Other Staff",
                            Toast.LENGTH_LONG).show();
                }
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (RRNo.trim().length() <= 0){
                    Toast.makeText(result.this, "Regno field is Required to Delete!!",
                            Toast.LENGTH_LONG).show();
                }
                else{
                    //getting access to the database by instantiating the subclass of SQLiteOpenHelper
                    ...
                    try {
                        ...
                        if (deletedRows > 0 ){
                            Toast.makeText(result.this, RRNo+" Deleted Successfully",
                                    Toast.LENGTH_LONG).show();
                        }
                        else{
                            Toast.makeText(result.this, RRNo+" User Not Deleted May Not Be Found",
                                    Toast.LENGTH_LONG).show();
                        }
                    }
                    catch (Exception e){
                        Toast.makeText(result.this, e.getMessage().toString()+"---Error Deleting User",
                                Toast.LENGTH_LONG).show();
                    }
                }
            }
